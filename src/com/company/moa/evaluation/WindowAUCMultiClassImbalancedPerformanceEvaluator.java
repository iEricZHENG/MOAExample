 ...
 *    
 */
package com.company.moa.evaluation;
...
public class WindowAUCMultiClassImbalancedPerformanceEvaluator extends AbstractOptionHandler implements ClassificationPerformanceEvaluator, Serializable {
	...
	public class Estimator implements Serializable {
		...
		protected moa.evaluation.WindowAUCImbalancedPerformanceEvaluator[] auc_2c;//store 2-class version of AUC for each class being the positive class (for calculating Provost's weighted AUC)

		protected moa.evaluation.WindowAUCImbalancedPerformanceEvaluator[] ewauc_2c;//store 2-class version of AUC for each class being the positive class (for calculating Provost's weighted AUC but with equal weight)
		...
		public Estimator(int sizeWindow) {
			...
			this.auc_2c = new moa.evaluation.WindowAUCImbalancedPerformanceEvaluator[numClasses];
			this.ewauc_2c = new moa.evaluation.WindowAUCImbalancedPerformanceEvaluator[numClasses];
			...
			for(int i = 0; i < numClasses; i++) {
				...
				auc_2c[i] = new moa.evaluation.WindowAUCImbalancedPerformanceEvaluator();
